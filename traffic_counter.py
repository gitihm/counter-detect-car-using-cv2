...
cap = cv2.VideoCapture('data/c8.mp4')
...
while True:
    ...
    if ret:  # if there is a frame continue with code
        ...
        cv2.rectangle(image, (0, 0), (250, 50), (255, 255, 255), -1)  # background rectangle for on-screen text
        ...
        if carscrossedup != pev_in:
            firebase.put('/user','in',carscrossedup)
        ...
        if carscrossedup != pev_out:
            firebase.put('/user','out',carscrosseddown)
